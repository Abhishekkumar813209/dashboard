...
function Navbar() {
  ...
  return (
    <>
      ...
      <NavButton title="Chat" dotColor='#03C9D7' customFunc={()=> handleClick('chat')} color="blue" icon={<RiNotification3Fill />}/>
      <NavButton title="Chat" dotColor='#03C9D7' customFunc={()=> handleClick('notification')} color="blue" icon={<RiNotification3Fill />}/>
